...
/**
 ...
 Use the LocationConfiguration07N app first to configure & tag your beacons. The ranging results will then include your custom tags, e.g., the aisle number & the department tag.
